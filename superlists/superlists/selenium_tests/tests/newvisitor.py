from superlists.selenium_tests.test import SeleniumTestCase
from superlists.selenium_tests.webdriver import CustomWebDriver
from selenium.webdriver.common.keys import Keys


class NewVisitorTest(SeleniumTestCase):
    def setUp(self):
        # Instantiate the custom web driver
        self.browser = CustomWebDriver()

    def tearDown(self):
        # Don't forget to tear down the web driver when finished
        self.browser.quit()
